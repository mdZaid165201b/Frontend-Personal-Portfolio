...
const Project = ({ data }) => {
  ...
  return (
    <div className=" bg-gradient-to-br from-emerald-600 to-cyan-500 sm:w-[480px] sm:h-[280px] h-[200px] rounded-md p-[2.0px] mt-14 mx-4 shadow-md shadow-gray-700">
      <div className=" w-full h-full rounded-lg hover:ease-in hover:duration-[300ms,500ms] overflow-hidden transition-transform relative cursor-pointer">
        <div className=" w-full h-full ">
          <img src={data.img} alt="proj" className="w-full h-full rounded-md overflow-clip " />
        ...
        >
          <div className="flex flex-col justify-center items-center">
            <h1 className="text-gray-200 text-2xl hover:text-3xl">
              {data.title}
            </h1>
