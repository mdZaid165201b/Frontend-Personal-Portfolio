...
import {findUser, setUser} from "../redux/features/profile/profile";
                ...
                <div className="my-10 sm:my-28" id="hero">
                    <div className="flex items-center justify-center flex-col">
                        <div className="bg-gradient-to-br p-[3px] from-green-700 to-sky-700 rounded-full">
                            <img
                                className=" rounded-full filter contrast-125 grayscale duration-150 shadow-xl -z-20 shadow-gray-700/5 w-[200px] h-[200px] sm:w-[250px] sm:h-[250px] rounded-full object-cover bg-cover"
                        ...
                        <div className="text-center">
                            <h1 className=" text-3xl tracking-wider my-10 text-gray-200">
                                Hello, I'm{" "}
                                <span
                                    className="text-transparent bg-clip-text bg-gradient-to-r to-green-600 from-sky-500 font-extrabold">
                ZAID
              </span>
                                ,
                                <br/>
                ...
                <span className="text-transparent bg-clip-text bg-gradient-to-r to-green-600 from-sky-500">
                  FullStack Developer
                            ...
                            <h1 className="text-gray-400 text-md sm:text-xl w-screen sm:w-[700px] tracking-wider">
                                {user.tagLine ? user.tagLine : "Full-stack developer with 1 year of experience in building web\n" +
