...
const Contact = () => {
    ...
    const validateInput = (input) => {
        if (fromName !== "" || toName !== "" || message !== "" || email !== "") {
            return true;
        }
        else { return false }
    }
    ...
    const submitMessage = async () => {
        ...
        try {
            if (validateInput({fromName, message, email, toName})) {
              ...
              Swal.fire({
                icon: 'error',
                title: "<h5 style='color:white'>" + "Oops..." + "</h5>",
                text: "Something went wrong!!!",
    ...
    return (
        <div className="flex flex-col justify-center " id="contacts">
            ...
            "
                    ...
                    <button
                        className={`mt-5  bg-gradient-to-br from-teal-600 to-sky-700 py-3 px-2 sm:px-3 rounded-md shadow-md tracking-wider hover:bg-[#126f72] duration-100 `}
                        disabled={loading} onClick={submitMessage}>
